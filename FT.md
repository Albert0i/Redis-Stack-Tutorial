...
### I. The variance 
Ever since I started to learn relational databases, we were quite used to see things organized in hierarchy, ie. database, schema, table, record, fields... line byline and step by step along the way from top down. Everything was kept  clean and tidy. 
![alt phpMyAdmin](img/phpMyAdmin.JPG)

When I scratched [MongoDB](https://www.mongodb.com/), similar hierarchy emerges, ie. database, collection, document, properties... etc. 
![alt MongoDB Compass](img/MongoDB_Compass.JPG)

Later on, I come access [Redis Stack](https://redis.io/docs/about/about-stack/), another specie of NoSQL variance, almost shock swooned. Everything was kept in top-level, By keeping everything at the top level, a constant-time access through primary keys is attained. The simplicity and speed have made it a popular choice for applications that require fast and efficient data access. 
