...
For some unknown reason, I was responsible for maintaining some [Stone Age](https://wallpapers.com/images/featured/the-flintstones-pictures-wthl97y7ez0xrnds.webp) [ASP](https://en.wikipedia.org/wiki/Active_Server_Pages) query programs built with *titanic* SQL statement, one of which is around 350 lines, which ran for several SECONDS, not milliseconds... Curiosity urged me to quest for how RDBMS handle it, therefore I used `explain plan for SELECT...`, Wow! the access plan was 350 lines. This SQL is a whole bunch of shit entangled with 32 sub-queries... The problem here is not to do with *What we can* but *What we should*. Crafting SQL statement to this extend is a behaviour of extreme abusiveness and obscenity, had evidently soiled the chastity and purity of SQL. 
